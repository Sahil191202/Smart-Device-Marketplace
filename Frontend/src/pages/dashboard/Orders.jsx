        ...
        return (
          <div key={i} className="flex gap-3">
            <div className="flex flex-col items-center">
              <div
                className={`w-7 h-7 rounded-full ${cfg.bg} flex items-center justify-center flex-shrink-0`}
              >
            ...
            <div className="flex flex-col items-center">
              ...
              <span
                className={`text-[10px] mt-1 font-medium ${
                  done || active ? "text-primary-600" : "text-slate-400"
                }`}
              >
                {cfg.label.split(" ")[0]}
              </span>
        ...
        <div className="flex items-center justify-between mt-4 pt-4 border-t border-slate-100 dark:border-slate-700/50">
          <div className="flex items-center gap-2">
            ...
            {canCancel && (
              ...
              >
                Cancel {order.refundInitiated ? "& Refund" : ""}
              </Button>
            )}
